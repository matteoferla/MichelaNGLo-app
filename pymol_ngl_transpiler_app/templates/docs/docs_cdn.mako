...
<pre><div class="float-right"><a href="#cdn_code" data-clipboard-target="#snippet" class="clipboard">Copy</a></div><code id="cdn_code">&lt;script src="https://unpkg.com/ngl@2.0.0-dev.34/dist/ngl.js" type="text/javascript"&gt;&lt;/script&gt;
...
<pre><div class="float-right"><a href="#local_code" data-clipboard-target="#snippet" class="clipboard">Copy</a></div><code id="local_code">&lt;script src="/ngl.js" type="text/javascript"&gt;&lt;/script&gt;
