...
class Page:
    def __init__(self, identifier, key=None):
        ...
        self.unencrypted_path = os.path.join('pymol_ngl_transpiler_app', 'user-data', self.identifier + '.p')
        self.encrypted_path = os.path.join('pymol_ngl_transpiler_app', 'user-data', self.identifier + '.ep')
        if key:
    ...
    def is_password_protected(self, raise_error = False):
        path_exists = os.path.exists(os.path.join('pymol_ngl_transpiler_app', 'user-data', self.identifier + '.p'))
        epath_exists = os.path.exists(os.path.join('pymol_ngl_transpiler_app', 'user-data', self.identifier + '.ep'))
