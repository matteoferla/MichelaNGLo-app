<ul class="nav nav-tabs">
    %for url, name in [('github', 'Inner workings'), ('implementations', 'Implementing a view'), ('markup','Prolinks'), ('cite','Citation'), ('api','API'), ('clash','Clash'), ('users','Users & pages'), ('gene','Starting with a gene name'), ('video', 'Video tutorials')]:
