...
<h4>Citation</h4>
    <ul>
        <li><a href="https://doi.org/10.1093/bioinformatics/btaa104" target="_blank">Ferla MP, Pagnamenta AT, Damerell D, Taylor JC, Marsden BD. Michelanglo:  sculpting protein views on web pages without coding. Bioinformatics. 2020 Feb 15. <i class="far fa-external-link"></i></a></li>
