    ...
    <div class="row">
        ...
        <div class="col-12 col-md-5">
            ...
            <div class="d-flex justify-content-center">
                <button type="button" class="btn btn-outline-secondary border-0" id="pause"><i class="far fa-pause"></i>
                </button>
                <button type="button" class="btn btn-outline-secondary border-0" id="resume" style="display: none;"><i
                        class="far fa-play"></i></button>
                %for i in range(4):
                    <button type="button" class="btn btn-outline-secondary border-0" id="frame${i}"><i
...
<%block name="script">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            window.time_fn = () => {
                // slow 3G failsafe
                if (window.NGL === undefined) return;
                if (window.NGL.specialOps === undefined) return;
                if (NGL.getStage('viewport').getComponentByType('structure') === undefined) return;
                views[tock]();
