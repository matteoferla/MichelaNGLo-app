...
NGL.specialOps.hardReset = function () {  //when the page is faux-refreshed.
    ...
    if (NGL.Debug) {console.log('HARD RESET.');}
};
...
NGL.specialOps.multiLoader = function (id, proteins, backgroundColor, startIndex) {
    ...
    if (img.length) {
        ...
        img.click(() => {NGL.specialOps.load(startIndex); $('#img_label').detach();});
    }
...
$.prototype.viewport = function () {
        ...
        if (NGL.Debug) {console.log('old viewport sizes:'+$(this).width()+'x'+$(this).height());}
        ...
        else if (typeof data == "string") {console.log(data); data = JSON.parse(data);}
